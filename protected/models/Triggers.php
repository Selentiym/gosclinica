...
class Triggers extends CTModel
{
	...
	public function beforeDelete() {
		//After deleting the Trigger we have to delete its values.
		$del = true;
	...
	public function giveSpecialityTrigger() {
		return Triggers::model() -> findByAttributes(array('verbiage' => 'speciality'));
	}
}
