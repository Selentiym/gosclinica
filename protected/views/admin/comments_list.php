...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns'=>array(
		...
		array(
			'name' => 'approved',
			'header' => "Одобрен/не одобрен",
			'value' => function ($com) {
				echo '<div class="change">';
				echo '<a href="'.Yii::app() -> baseUrl.'/admin/commentToggle?id='.$com -> id.'">';
				if ($com -> approved) {
					echo "Одобрен";
				} else {
					echo "Не одобрен";
		...
		/*array(
            ...
            'value' => '<div class="'.(($data->approved == 1)? "change" : "change").'">'.(($data->approved == 1)? CHtml::encode("Отклонить"): CHtml::encode("Одобрить")).'</div>',
