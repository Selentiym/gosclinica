    ...
    <!--<div class="middle_inner_footer_block clearfix">
        <div class="left_middle_inner_footer_block left">
            <ul>
                ...
                <li class="tw"><noindex><a href="https://twitter.com/medbookingru" target="_blank" rel="nofollow" class="twitter"></a></noindex></li>
                <li class="vk"><noindex><a href="http://vk.com/medbooking" target="_blank" class="vk"></a></noindex></li>
                <li class="inst"><noindex><a href="http://instagram.com/medbooking" target="_blank" rel="nofollow" class="instagram"></a></noindex></li>
