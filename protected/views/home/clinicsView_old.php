...
<div class="row-fluid">
        <div class="span4">
            ...
            <div class="span2">
                <div class="topped">
                    <p><?php echo  CHtml::link('<span class="icon-headphones"></span>&nbsp;' . CHtml::encode('Слушать аудио'), Yii::app()->baseUrl.'/clinics/'.$model->verbiage . '/other#audio', array('class' => 'btn btn-warning')); ?></p><br/>
                    <p><?php echo  CHtml::link('<span class="icon-facetime-video"></span>&nbsp;' . CHtml::encode('Смотреть видео') , Yii::app()->baseUrl.'/clinics/'.$model->verbiage . '/other#video', array('class' => 'btn btn-info')); ?></p><br/>
                    <p><?php echo  CHtml::link('<span class="icon-comment"></span>&nbsp;' . CHtml::encode('Читать отзывы') , Yii::app()->baseUrl.'/clinics/'.$model->verbiage . '/other#comments', array('class' => 'btn btn-success')); ?></p>
                </div>
        </div>
        ...
        <div class="span6">
                ...
                foreach($images as $image) {
                    if (trim($image) != "") {
                        //$image_path = Yii::app()->baseUrl. '/images/clinics/' . $model->id . '/' . trim($image);
                        $image_path = $model -> giveImageFolderRelativeUrl() . trim($image);
                        //$image_real_path = Yii::app()->basePath. '/../images/clinics/' . $model->id . '/' . trim($image);
