...
<div class="row-fluid">
    ...
    <div class="span5">
        ...
        <div>
            <?php echo $form->labelEx($model,'about_clinic'); ?>
            <?php echo $form->textArea($model,'about_clinic',array('size'=>60)); ?>
            <?php echo $form->error($model,'about_clinic'); ?>
        </div>

        <div>
            <?php echo $form->labelEx($model,'prices_text'); ?>
            <?php echo $form->textArea($model,'prices_text',array('size'=>60)); ?>
            <?php echo $form->error($model,'prices_text'); ?>
        </div>
